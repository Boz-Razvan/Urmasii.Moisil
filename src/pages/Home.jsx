  ...
  return (
    <div className="Page">
      ...
      <div className="body">
        ...
        <h2 className="content">
          Competiția a fost inițiată în anul 2001
          de către Liceul Teoretic de Informatică „Grigore Moisil” din Iaşi, în
          onoarea patronului liceului, academicianul Grigore C. Moisil (1906 –
          1973), fondator de şcoală de informatică în România, personalitate
          recunoscută pe plan mondial pentru fundamentarea informaticii ca
          ştiinţă.
        </h2>
        <h2 className="content">
          În acest an școlar Concursul Naţional de Informatică “Urmaşii lui
